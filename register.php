                ...
                <div class="max-w-xl lg:max-w-3xl">
                    ...
                    <form method="POST" action="#" class="mt-8 grid grid-cols-6 gap-6">
                        <div class="col-span-12">
                            ...
                            <input type="text" id="nama" name="nama_lengkap" class="mt-1 w-full rounded-md py-1.5 px-2 border-gray-200 bg-white text-sm text-gray-700 shadow-sm" />
                        </div>
                        ...
                        <div class="col-span-12">
                            ...
                            <input type="email" id="Email" name="email" class="mt-1 w-full rounded-md py-1.5 px-2 border-gray-200 bg-white text-sm text-gray-700 shadow-sm" />
                        </div>
                        ...
                        <div class="col-span-12">
                            ...
                            <input type="password" id="Password" name="password" class="mt-1 w-full rounded-md py-1.5 px-2 border-gray-200 bg-white text-sm text-gray-700 shadow-sm" />
                        </div>
