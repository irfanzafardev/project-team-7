    ...
    <main>
        <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
            ...
            <div class="space-y-10 divide-y divide-gray-900/10 mt-5">
                <form method="POST" action="controller.php" class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl">
                    <div class="px-4 py-6 sm:p-8">
                        <div class="grid gap-y-4">
                            <div class="col-span-full">
                                ...
                                <div class="mt-2">
                                    <input type="text" id="nama_barang" name="nama_barang" class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" aria-describedby="tanggal-description" />
                            ...
                            <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                ...
                                ?>
                                    <button type="submit" name="action" value="add" class="inline-flex w-full justify-center rounded-md bg-indigo-900 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-800 sm:ml-3 sm:w-auto">
                                        Submit
                                    </button>
                                <?php
                                }
