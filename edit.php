...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    // echo 'a';
    $updateProduct = $productClass->updateProduct($_POST, $id);
}
?>
        ...
        <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    <h1 class="text-base font-semibold leading-6 text-gray-900">Edit Produk</h1>
                    <p class="mt-2 text-sm text-gray-700">Form edit data produk</p>
                </div>
            </div>
                            ...
                            <div class="px-4 py-6 sm:p-8">
                                <div class="grid gap-y-4">
                                    ...
                                    <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                        <button type="submit" name="action" value="update" class="inline-flex w-full justify-center rounded-md bg-indigo-900 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-800 sm:ml-3 sm:w-auto">
                                            Update
                                        </button>
